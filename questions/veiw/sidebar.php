		...
		<div class="col-md-5">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<?php 
						$q="select q.q_id, q.question, count(a.answer_id) as Total_Ans from user_questions q LEFT JOIN user_answers a on q.q_id=a.question_id group by q.q_id order by Total_Ans desc limit 5";
